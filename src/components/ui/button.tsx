  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-navy text-navy-foreground shadow-lg hover:bg-navy/90 hover:shadow-xl",
        premium: "bg-brand text-brand-foreground shadow-md hover:bg-brand/90 hover:shadow-lg",
        gold: "bg-gold text-gold-foreground shadow-md hover:bg-gold/90",
